...
-- -----------------------------------------------------
CREATE TABLE author (
  id_author INT GENERATED BY DEFAULT ON NULL AS IDENTITY PRIMARY KEY,
...
CREATE TABLE editorial (
  id_editorial INT GENERATED BY DEFAULT ON NULL AS IDENTITY PRIMARY KEY,
...
-- -----------------------------------------------------
CREATE TABLE book (
  id_book INT GENERATED BY DEFAULT ON NULL AS IDENTITY PRIMARY KEY,
